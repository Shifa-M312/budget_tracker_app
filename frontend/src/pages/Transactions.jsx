          ...
          <form onSubmit={handleFormSubmit} className="space-y-4">
            ...
            <div className="pt-2 border-t border-gray-100">
              ...
              <input
                ...
                className="text-sm text-gray-500 file:mr-4 file:py-1 file:px-3 file:rounded file:border-0 file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer"
              />
            </div>

            <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 rounded transition shadow">
              Submit Transaction
            </button>
          </form>
        </div>
              ...
              {transactions.map((t) => (
                <div key={t._id} className="py-3 flex justify-between items-center hover:bg-gray-50 rounded px-2 transition">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {t.image && (
                      <a href={t.image} target="_blank" rel="noreferrer" title="View Uploaded Receipt">
                        <img src={t.image} alt="receipt" className="w-8 h-8 object-cover rounded border hover:scale-105 transition" />
                      </a>
                    )}
